...
function renderButtons() {
  ...
  allButtons.forEach((btn) => {
    ...
    // const parsedWithRegex = btn.className
    //   .replace(/(btn|btn-|active|-)/g, "")
    //   .trim();
    // console.log(parsedWithRegex);
    ...
    // paragraph.textContent = `${btn.className}: ${parsedBtn}`;

    for (let key in state) {
      // e.g : key => greenPeppers
